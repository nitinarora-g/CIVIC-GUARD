export const INDIA_STATES_AND_DISTRICTS: Record<string, string[]> = {
  "Andhra Pradesh": [
    ...
    "Vizianagaram", "West Godavari", "Anakapalli", "Bapatla", "Eluru",
    "Kakinada", "Konaseema", "Nandyal", "Palnadu", "Parvathipuram Manyam",
    "Sri Satya Sai", "Tirupati", "NTR", "Sri Potti Sriramulu Nellore", "Alluri Sitharama Raju"
  ],
  "Arunachal Pradesh": [
  ...
  "Chhattisgarh": [
    ...
    "Bilaspur", "Dantewada", "Dhamtari", "Durg", "Gariaband", "Janujgir-Champa",
  ...
  "Kerala": [
    ...
    "Thiruvananthapuram", "Trissur", "Wayanad"
  ],
  "Madhya Pradesh": [
...
export const INDIA_STATES = Object.keys(INDIA_STATES_AND_DISTRICTS).sort();
